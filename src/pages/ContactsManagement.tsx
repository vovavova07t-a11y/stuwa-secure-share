...
import { Building, FileText, Mail, Phone, Users, Calendar, ArrowLeftRight } from 'lucide-react';
...
const categories = [
  { id: 'contacts_company_resume', name: 'Резюме компании', icon: Building },
  { id: 'contacts_incoming', name: 'Входящая корреспонденция', icon: Mail },
  { id: 'contacts_outgoing', name: 'Исходящая корреспонденция', icon: FileText },
  { id: 'contacts_meetings', name: 'Протоколы встреч', icon: Calendar },
  { id: 'contacts_internal', name: 'Внутренняя документация', icon: Users },
  { id: 'contacts_communications', name: 'Внешние коммуникации', icon: Phone }
];
      ...
      <div className="container mx-auto px-4 py-6">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Офис-менеджер</BreadcrumbPage>
            </BreadcrumbItem>
          ...
          <div className="animate-fade-in">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">
                Управление корреспонденцией и офисной документацией
              </p>
            </div>
                  ...
                  <CardContent>
                    {showUpload ? (
                      <UniversalFileUpload
                        ...
                        onFilesChange={(files) => {
                          console.log(`Офисные файлы для категории ${selectedCategory}:`, files);
                        }}
                      />
                    ) : (
